...
const vueRule = require('./config/rules/vue')
const sassRule = require('./config/rules/sass')
const fontsRule = require('./config/rules/fonts')
const imagesRule = require('./config/rules/images')
const javascriptRule = require('./config/rules/javascript')
const externalFontsRule = require('./config/rules/external.fonts')
const externalImagesRule = require('./config/rules/external.images')
